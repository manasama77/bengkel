...
@endif
        ...
        <div class="row">
          <div class="col-xl-6 mb-xl-0 mb-3">
            ...
            <div class="btn-group" role="group" aria-label="Third group">
              <a href="{{route('admin.pelanggan.create')}}" type="button" class="btn btn-outline-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah">
    ...
    <div class="card">
       <x-pelanggan.pelanggan-table :items="$items"></x-pelanggan.pelanggan-table>
    </div>
