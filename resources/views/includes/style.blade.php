...
<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('/') }}assets/template/sneat/assets/vendor/css/core.css"
    class="template-customizer-core-css" />
<link rel="stylesheet" href="{{ asset('/') }}assets/template/sneat/assets/vendor/css/theme-default.css"
    class="template-customizer-theme-css" />
<link rel="stylesheet" href="{{ asset('/') }}assets/template/sneat/assets/css/demo.css" />

<!-- Vendors CSS -->
<link rel="stylesheet"
    href="{{ asset('/') }}assets/template/sneat/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
...
<link href="https://cdn.datatables.net/v/bs5/dt-1.13.6/b-2.4.2/datatables.min.css" rel="stylesheet">
adam
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
